    ...
    <div className="min-h-screen bg-gray-100 ">
      ...
      <section className="bg-[#1b546f] text-white py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <a href="https://github.com/IWuYhong/portafolio_richard/blob/main/images/Richard%20Da%20Silva%20_%20LinkedIn.pdf" className="button-bezel bg-[#129dc8] w-full text-center py-2 px-6 rounded-lg hover:bg-[#127ea8] transition duration-300">Mi CV</a>
        </div>
